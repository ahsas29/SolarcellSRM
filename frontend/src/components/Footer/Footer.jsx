...
const socialLinks =[
  {
    path:"https://www.youtube.com/@SRMeducation",
    icon: <AiFillYoutube className="group-hover:text-white w-4 h-5" />,
  },
  {
    path:"https://github.com/ahsas29",
    icon:<AiFillGithub className="group-hover:text-white w-4 h-5" />,
  },
  {
    path: "https://www.instagram.com/ahsas.srivastava/",
    icon: <AiOutlineInstagram className="group-hover:text-white w-4 h-5" />,
  },
  {
    path: "https://www.linkedin.com/in/ahsas-srivastava-976065189/",
        ...
        <div className="flex justify-between flex-col md:flex-row flex-wrap gap-[30px]">
          <div>
            ...
            <p className="text-[16px] leading-7 font-[400] text-textColor mt-4">
              copyright © {year} developed by Ahsas Srivastava all rights reserved.
            </p>
